...
class BagFragment : Fragment(), CartItemClickAdapter {
    ...
    lateinit var totalDiscountedAmount:TextView
    ...
    override fun onCreateView(
        ...
        totalDiscountedAmount = view.findViewById(R.id.totalDiscountedAmount)
        ...
        cartViewModel.allproducts.observe(viewLifecycleOwner, Observer {List ->
            ...
            totalPriceBagFrag.text = "Ksh. " + sum
            val discount = sum.toInt() * 0.85
            val d = discount.toString()
            totalDiscountedAmount.text = "Ksh. " + d
        })
